...
WITH
base_mensual (merchant_id, kam_asignado_email, mes_transferencia) AS (
    VALUES
        ('0CZTLXEOXY', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('7DVLTIUMHX', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('RMCVFJO3D8', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('60WPJO2DZX', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('8R8UIAMUC6', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('PA1LA4GGYD', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('WFK9N0809K', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('3SQNBLP4ZN', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('LG773V6IUV', CAST(NULL AS varchar), CAST(NULL AS varchar)),
        ('VMKYJPDVD1', CAST(NULL AS varchar), CAST(NULL AS varchar))
),
